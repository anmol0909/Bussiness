...
class IdproofsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create idproof" do
    assert_difference("Idproof.count") do
      post idproofs_url, params: { idproof: { document: @idproof.document, merchant_id: @idproof.merchant_id } }
    end
  ...
  test "should update idproof" do
    patch idproof_url(@idproof), params: { idproof: { document: @idproof.document, merchant_id: @idproof.merchant_id } }
